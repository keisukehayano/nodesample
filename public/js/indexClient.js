...
$(window).on('load', function() {
  console.log('####load####');
  getProductListAll();
  var singleSearchValue = getParam('singlesearch');
  if (singleSearchValue != null) {
    console.log('single_page From:' + singleSearchValue);
    getProductsBySearch(singleSearchValue);
  }
...
function getProductsBySearch(productName) {
